<!-- skins/tpl/admin/route/form.tpl begin -->
    <div class="main_edit">
...
<textarea id="text" name="form[value1]" cols="120" rows="30"><?php echo $route_content; ?></textarea>
<br /><br />
<input name="edit" type="submit" value="Сохранить" />
</form>
    </div>
<!-- skins/tpl/admin/route/form.tpl end -->